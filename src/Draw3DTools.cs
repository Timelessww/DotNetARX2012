...
public static partial class Draw3DTools
{
        ...
        ObjectId solid3dId1, ObjectId solid3dId2)
    {
        ...
        var ent1 = trans.GetObject(solid3dId1, OpenMode.ForWrite) as Entity;
        var ent2 = trans.GetObject(solid3dId2, OpenMode.ForWrite) as Entity;
        ...
        if (ent1 is Solid3d solid3dEnt1 && ent2 is Solid3d solid3dEnt2)
        {
            solid3dEnt1.BooleanOperation(boolType, solid3dEnt2);
            ent2.Dispose();
        }
        if (ent1 is Region regionEnt1 && ent2 is Region regionEnt2)
        {
