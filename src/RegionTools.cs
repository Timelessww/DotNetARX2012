...
public static class RegionTools
{
    ...
    static extern ErrorStatus getAreaProp(IntPtr region,
                                            ref Point3d origin,
                                            ref Vector3d xAxis,
                                            ref Vector3d yAxis,
...
#pragma warning disable IDE0052 // 删除未读的私有成员
    ...
    readonly static double[] momInertia = new double[2];
    static double prodInertia;
    readonly static double[] prinMoments = new double[2];
    readonly static Vector2d[] prinAxes = new Vector2d[2];
    readonly static double[] radiiGyration = new double[2];
