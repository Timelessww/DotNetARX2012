...
public class PlotSettingsEx : PlotSettings, INotifyPropertyChanged
{
    ...
    public double Denominator
    {
        ...
        set
        {
            ...
            {
                CustomScale newScale = new(CustomPrintScale.Numerator, value);
    ...
    public double Numerator
    {
        ...
        set
        {
            if (value != Numerator)
            {
                CustomScale newScale = new(value, CustomPrintScale.Denominator);
                validator.SetCustomPrintScale(this, newScale);
    ...
    public double PlotOriginX
    {
        ...
        set
        {
            ...
            {
                Point2d newOrigin = new(value, PlotOrigin.Y);
    ...
    public double PlotOriginY
    {
        ...
        set
        {
            ...
            {
                Point2d newOrigin = new(PlotOrigin.X, value);
                validator.SetPlotOrigin(this, newOrigin);
    ...
    public List<string> DeviceList
    {
        get
        {
            var deviceCollection = validator.GetPlotDeviceList();
    ...
    public List<string> MediaList
    {
        get
        {
            var mediaCollection = validator.GetCanonicalMediaNameList(this);
    ...
    /// 获取标准打印比例列表
    /// </summary>
    public static Dictionary<StdScaleType, string> StdScaleTypeList
    {
        get
        {
            var scaleTypeDict = new Dictionary<StdScaleType, string>();
            List<string> scaleTypeList = new()
            {
    ...
    public string PlotTypeLocal
    {
        ...
        set
        {
            if (value != PlotTypeLocal)
            {
                ...
                {
                    case "显示":
                        PlotType = PlotType.Display;
                        break;
                    case "范围":
                        PlotType = PlotType.Extents;
                        break;
                    case "布局":
                        PlotType = PlotType.Layout;
                        break;
                    case "图形界限":
                        PlotType = PlotType.Limits;
                        break;
                    case "视图":
                        PlotType = PlotType.View;
                        break;
                    case "窗口":
    ...
    public string StdScaleTypeLocal
    {
        get
        {
            if (!UseStandardScale) return "自定义";
                ...
                return PlotSettingsEx.StdScaleTypeList[StdScaleType];
        }
        set
        {
            if (value != StdScaleTypeLocal)
            {
                ...
                在此之后:
                                    StdScaleType newScaleType= PlotSettingsEx.StdScaleTypeList.FirstOrDefault(s => s.Value == value).Key;
                */
                StdScaleType newScaleType = StdScaleTypeList.FirstOrDefault(s => s.Value == value).Key;
